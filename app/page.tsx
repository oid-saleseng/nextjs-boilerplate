    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start w-full max-w-md">
        <Image
          ...
          priority
        />
        <ol className="list-inside list-decimal text-sm/6 text-center sm:text-left font-[family-name:var(--font-geist-mono)] w-full">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row mt-12 w-full justify-center sm:justify-start">
          <a
      ...
      <footer className="row-start-3 flex gap-[24px] flex-wrap items-center justify-center">
        ...
        <a
          className="flex items-center gap-2 hover:underline hover:underline-offset-4"
          href="https://vercel.com/templates?framework=create-next-app"
          target="_blank"
          rel="noopener noreferrer"
        >
          Vercel Templates
