...
export default function SSOLogin() {
 ...
 const handleSubmit = (e: React.FormEvent) => {
  ...
  if (lowerEmail.endsWith("@orga.com")) {
    const redirectUrl = "https://ciam-se-saas.onelogin.com/access/initiate?iss=https://se-b2b-org-a.onelogin.com/oidc/2&target_link_uri=https://ciam-se-saas.onelogin.com/start/4015637";
